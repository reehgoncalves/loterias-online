...
class Bet extends Model {
    protected $fillable = ['user_id','order_id','lottery_game_id','draw_id','numbers','amount_cents','potential_prize_cents','payout_cents','status','payment_status','is_pool_share','idempotency_key','paid_at','settled_at','won_at','settlement_note'];
