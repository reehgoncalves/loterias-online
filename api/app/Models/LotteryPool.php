...
class LotteryPool extends Model {
    protected $fillable = ['lottery_game_id','draw_id','name','description','lines','numbers_count','share_price_cents','total_shares','sold_shares','reserved_shares','total_stake_cents','status'];
